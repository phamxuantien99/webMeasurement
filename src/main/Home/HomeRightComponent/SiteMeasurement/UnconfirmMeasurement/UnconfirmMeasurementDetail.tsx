...
import "../../../InvoiceCase2/InvoiceCase2Style.css";
...
function UnconfirmMeasurementDetail() {
  const { id } = useParams();
  ...
  console.log({ dataDetailReportMeasurement });
  console.log(dataDetailReportMeasurement?.lintel);
                    ...
                    <tr>
                      ...
                      >
                        {dataDetailReportMeasurement?.crane ? (
                          <GoDotFill size={16} className="dot text-center" />
                        ) : (
                          <></>
                        )}
                      </th>
...
export default UnconfirmMeasurementDetail;
